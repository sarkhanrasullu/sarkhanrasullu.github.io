...
v("WeakMap",function(a){function b(k){this.f=(h+=Math.random()+1).toString();if(k){k=q(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}
function c(){}
...
function d(h,k){var l=k&&typeof k;"object"==l||"function"==l?f.has(k)?l=f.get(k):(l=""+ ++g,f.set(k,l)):l="p_"+k;var m=h.g[l];if(m&&w(h.g,l))for(var p=0;p<m.length;p++){var u=m[p];if(k!==k&&u.key!==u.key||k===u.key)return{id:l,list:m,index:p,u:u}}return{id:l,list:m,index:-1,u:void 0}}
...
v("Set",function(a){function b(c){this.f=new Map;if(c){c=q(c);for(var d;!(d=c.next()).done;)this.add(d.value)}this.size=this.f.size}
...
b.prototype.then=function(g,h){function k(u,t){return"function"==typeof u?function(B){try{l(u(B))}catch(K){m(K)}}:t}
var l,m,p=new b(function(u,t){l=u;m=t});
...
b.all=function(g){var h=q(g),k=h.next();return k.done?d([]):new b(function(l,m){function p(B){return function(K){u[B]=K;t--;0==t&&l(u)}}
var u=[],t=0;do u.push(void 0),t++,d(k.value).aa(p(u.length-1),m),k=h.next();while(!k.done)})};
return b});
...
function Jb(a){if(a instanceof Gb&&a.constructor===Gb&&a.h===Hb)return a.f;za(a);return"type_error:SafeHtml"}
var Hb={};function Kb(a,b){var c=new Gb;c.f=a;c.g=b;return c}
Kb("<!DOCTYPE html>",0);var Lb=Kb("",0);Kb("<br>",0);function Mb(a,b){var c=b instanceof G?b:Cb(b);a.href=Ab(c)}
...
;function Wb(a){this.f=Ma(a.url,a.vb)}
...
ec&&(dc=ec?ec[1]:"");if(Yb){var fc=bc();if(null!=fc&&fc>parseFloat(dc)){cc=String(fc);break a}}cc=dc}var gc=cc,hc;if(x.document&&Yb){var ic=bc();hc=ic?ic:parseInt(gc,10)||void 0}else hc=void 0;var jc=hc;var kc={},lc=null;var L=window;function mc(a){this.f=a||{cookie:""}}
...
return a}
var Ec={cb:"allow-forms",eb:"allow-modals",fb:"allow-orientation-lock",gb:"allow-pointer-lock",hb:"allow-popups",ib:"allow-popups-to-escape-sandbox",jb:"allow-presentation",kb:"allow-same-origin",lb:"allow-scripts",mb:"allow-top-navigation",nb:"allow-top-navigation-by-user-activation"},Gc=Va(function(){return Fc()});
...
;var Kc=(new Date).getTime();function Lc(a){if(!a)return"";a=a.split("#")[0].split("?")[0];a=a.toLowerCase();0==a.indexOf("//")&&(a=window.location.protocol+a);/^[\w\-]*:\/\//.test(a)||(a=window.location.href);var b=a.substring(a.indexOf("://")+3),c=b.indexOf("/");-1!=c&&(b=b.substring(0,c));a=a.substring(0,a.indexOf("://"));if("http"!==a&&"https"!==a&&"chrome-extension"!==a&&"file"!==a&&"android-app"!==a&&"chrome-search"!==a&&"app"!==a)throw Error("Invalid URI scheme in origin: "+a);c="";var d=b.indexOf(":");if(-1!=d){var e=
b.substring(d+1);b=b.substring(0,d);if("http"===a&&"80"!==e||"https"===a&&"443"!==e)c=":"+e}return a+"://"+b+c}
;function Mc(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;m=l=0}
function b(p){for(var u=g,t=0;64>t;t+=4)u[t/4]=p[t]<<24|p[t+1]<<16|p[t+2]<<8|p[t+3];for(t=16;80>t;t++)p=u[t-3]^u[t-8]^u[t-14]^u[t-16],u[t]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],K=e[2],ma=e[3],Jc=e[4];for(t=0;80>t;t++){if(40>t)if(20>t){var Ga=ma^B&(K^ma);var Ib=1518500249}else Ga=B^K^ma,Ib=1859775393;else 60>t?(Ga=B&K|ma&(B|K),Ib=2400959708):(Ga=B^K^ma,Ib=3395469782);Ga=((p<<5|p>>>27)&4294967295)+Ga+Jc+Ib+u[t]&4294967295;Jc=ma;ma=K;K=(B<<30|B>>>2)&4294967295;B=p;p=Ga}e[0]=e[0]+p&4294967295;e[1]=
e[1]+B&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+ma&4294967295;e[4]=e[4]+Jc&4294967295}
function c(p,u){if("string"===typeof p){p=unescape(encodeURIComponent(p));for(var t=[],B=0,K=p.length;B<K;++B)t.push(p.charCodeAt(B));p=t}u||(u=p.length);t=0;if(0==l)for(;t+64<u;)b(p.slice(t,t+64)),t+=64,m+=64;for(;t<u;)if(f[l++]=p[t++],m++,64==l)for(l=0,b(f);t+64<u;)b(p.slice(t,t+64)),t+=64,m+=64}
function d(){var p=[],u=8*m;56>l?c(h,56-l):c(h,64-(l-56));for(var t=63;56<=t;t--)f[t]=u&255,u>>>=8;b(f);for(t=u=0;5>t;t++)for(var B=24;0<=B;B-=8)p[u++]=e[t]>>B&255;return p}
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,ya:function(){for(var p=d(),u="",t=0;t<p.length;t++)u+="0123456789ABCDEF".charAt(Math.floor(p[t]/16))+"0123456789ABCDEF".charAt(p[t]%16);return u}}}
;function Nc(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],F(d,function(h){e.push(h)}),Oc(e.join(" "));
...
;function Pc(a){var b=Lc(String(x.location.href)),c;(c=x.__SAPISID||x.__APISID||x.__OVERRIDE_SID)?c=!0:(c=new mc(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?x.__SAPISID:x.__APISID,c||(c=new mc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(x.location.href);return d&&c&&b?[b,Nc(Lc(d),c,a||null)].join(" "):null}return null}
...
var Vc;
function Wc(){var a=x.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!H("Presto")&&(a=function(){var e=xc(document,"IFRAME");e.style.display="none";e.src=ob(new lb(mb,jb())).toString();document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Jb(Lb));e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=A(function(k){if(("*"==h||
...
return d}
function af(a){if(Da(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Kb(a[b],null);a[c]=d}else af(a[b])}}
...
c.src=a}
;function hf(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ba(q(c)))}
r(hf,Error);var jf=new Set,kf=0;function lf(a){var b=z("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,!1,void 0):(b=oe(),b.push([a,"ERROR",void 0,void 0,!1,void 0]),P("ERRORS",b))}
function mf(a){var b=z("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,!1,void 0):(b=oe(),b.push([a,"WARNING",void 0,void 0,!1,void 0]),P("ERRORS",b))}
function nf(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function of(a,b,c,d,e,f){b=void 0===b?"ERROR":b;f=void 0===f?{}:f;f.name=c||Q("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);c=f||{};d=void 0===b?"ERROR":b;d=void 0===d?"ERROR":d;f=window&&window.yterr||!1;if(a&&f&&!(5<=kf)&&(R("console_log_js_exceptions")&&(f=[],f.push("Name: "+a.name),f.push("Message: "+a.message),a.hasOwnProperty("params")&&f.push("Error Params: "+JSON.stringify(a.params)),f.push("File name: "+a.fileName),f.push("Stacktrace: "+a.stack),
window.console.log(f.join("\n"),a)),0!==a.f)){f=a.g;b=a.columnNumber;if(a.args&&a.args.length)for(var g=0,h=0;h<a.args.length;h++){e=a.args[h];var k="params."+h;g+=k.length;if(e)if(Array.isArray(e))for(var l=c,m=0;m<e.length&&!(e[m]&&(g+=nf(m,e[m],k,l),500<g));m++);else if("object"===typeof e)for(l in l=void 0,m=c,e){if(e[l]&&(g+=nf(l,e[l],k,m),500<g))break}else c[k]=String(JSON.stringify(e)).substring(0,500),g+=c[k].length;else c[k]=String(JSON.stringify(e)).substring(0,500),g+=c[k].length;if(500<=
g)break}else if(a.hasOwnProperty("params"))if(e=a.params,"object"===typeof a.params)for(h in k=0,e){if(e[h]&&(g="params."+h,l=String(JSON.stringify(e[h])).substr(0,500),c[g]=l,k+=g.length+l.length,500<k))break}else c.params=String(JSON.stringify(e)).substr(0,500);a=oc(a);(f=f||a.stack)||(f="Not available");h=a.lineNumber.toString();isNaN(h)||!b||isNaN(b)||(h=h+":"+b);window.yterr&&Ca(window.yterr)&&(a.params=c,window.yterr(a));if(!(jf.has(a.message)||0<=f.indexOf("/YouTubeCenter.js")||0<=f.indexOf("/mytube.js"))){d=
{bb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:h,level:d,"client.name":c.name},C:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};c.version&&(d["client.version"]=c.version);if(d.C){f&&(d.C.stack=f);f=q(Object.keys(c));for(b=f.next();!b.done;b=f.next())b=b.value,d.C["client."+b]=c[b];if(c=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=q(Object.keys(c)),b=f.next();!b.done;b=f.next())b=b.value,d.C[b]=c[b]}We(Q("ECATCHER_REPORT_HOST","")+
"/error_204",d);jf.add(a.message);kf++}}}
;var pf=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",pf,void 0);function qf(a){me(pf,arguments)}
...
;var vf=z("ytPubsubPubsubInstance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.N;O.prototype.publish=O.prototype.M;O.prototype.clear=O.prototype.clear;y("ytPubsubPubsubInstance",vf,void 0);var wf=z("ytPubsubPubsubSubscribedKeys")||{};y("ytPubsubPubsubSubscribedKeys",wf,void 0);var xf=z("ytPubsubPubsubTopicToKeys")||{};y("ytPubsubPubsubTopicToKeys",xf,void 0);var yf=z("ytPubsubPubsubIsSynchronous")||{};y("ytPubsubPubsubIsSynchronous",yf,void 0);
function zf(a,b){var c=Af();if(c){var d=c.subscribe(a,function(){var e=arguments;var f=function(){wf[d]&&b.apply(window,e)};
try{yf[a]?f():S(f,0)}catch(g){ue(g)}},void 0);
wf[d]=!0;xf[a]||(xf[a]=[]);xf[a].push(d);return d}return 0}
function Bf(a){var b=Af();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),F(a,function(c){b.unsubscribeByKey(c);delete wf[c]}))}
...
function Ef(a){xf[a]&&(a=xf[a],F(a,function(b){wf[b]&&delete wf[b]}),a.length=0)}
;var Ff=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Gf=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Hf(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(Ff,""),c=c.replace(Gf,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else If(a,b,c)}
function If(a,b,c){c=void 0===c?null:c;var d=Jf(a),e=document.getElementById(d),f=e&&tf(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=zf(d,b),b=""+Ea(b),Kf[b]=f),g||(e=Lf(a,d,function(){tf(e,"loaded")||(rf(e),Cf(d),S(Ka(Df,d),0))},c)))}
function Lf(a,b,c,d){d=void 0===d?null:d;var e=xc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Mf(a){a=Jf(a);var b=document.getElementById(a);b&&(Df(a),b.parentNode.removeChild(b))}
function Nf(a,b){if(a&&b){var c=""+Ea(b);(c=Kf[c])&&Bf(c)}}
function Jf(a){var b=document.createElement("a");Mb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Pb(a)}
var Kf={};function Of(){}
function Pf(a,b){return Qf(a,1,b)}
;function Rf(){}
r(Rf,Of);function Qf(a,b,c){isNaN(c)&&(c=void 0);var d=z("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):S(a,c||0)}
...
ya(Rf);Rf.getInstance();var Sf=[],Tf=!1;function Uf(){if("1"!=Xa(pe(),"args","privembed")){var a=function(){Tf=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)};
Hf("//static.doubleclick.net/instream/ad_status.js",a);Sf.push(Pf(function(){Tf||"google_ad_status"in window||(Nf("//static.doubleclick.net/instream/ad_status.js",a),Tf=!0,P("DCLKSTAT",3))},5E3))}}
function Vf(){return parseInt(Q("DCLKSTAT",0),10)}
;function Wf(){this.g=!1;this.f=null}
Wf.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Hf(b,function(){g.g=!1;window.botguard?Xf(g,c,d,f):(Mf(b),mf(new hf("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Xf(this,c,d,f):mf(Error("Unable to load Botguard from JS")))};
function Xf(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:xa)}catch(e){mf(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){mf(e)}c&&c(b)}}
Wf.prototype.dispose=function(){this.f=null};var Yf=window,U=Yf.ytcsi&&Yf.ytcsi.now?Yf.ytcsi.now:Yf.performance&&Yf.performance.timing&&Yf.performance.now?function(){return Yf.performance.timing.navigationStart+Yf.performance.now()}:function(){return(new Date).getTime()};var Zf=new Wf,$f=!1,ag=0,bg="";function cg(a){R("botguard_periodic_refresh")?ag=U():R("botguard_always_refresh")&&(bg=a)}
function dg(a){if(a){if(Zf.g)return!1;if(R("botguard_periodic_refresh"))return 72E5<U()-ag;if(R("botguard_always_refresh"))return bg!=a}else return!1;return!$f}
function eg(){return!!Zf.f}
function fg(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Zf.f?Zf.f.invoke(void 0,void 0,a):null}
;var gg=0;y("ytDomDomGetNextId",z("ytDomDomGetNextId")||function(){return++gg},void 0);var hg={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
ig.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Za=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",Za,void 0);var kg=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",kg,void 0);
...
var mg=Va(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function V(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=lg(a,b,c,d);if(e)return e;e=++kg.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new ig(h);if(!Ac(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new ig(h);
h.currentTarget=a;return c.call(a,h)};
g=te(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),mg()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Za[e]=[a,b,c,g,d];return e}
function ng(a){a&&("string"==typeof a&&(a=[a]),F(a,function(b){if(b in Za){var c=Za[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?mg()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Za[b]}}))}
;var og=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function pg(a){this.w=a;this.f=null;this.j=0;this.m=null;this.l=0;this.h=[];for(a=0;4>a;a++)this.h.push(0);this.i=0;this.D=V(window,"mousemove",A(this.F,this));a=A(this.A,this);Ca(a)&&(a=te(a));this.K=window.setInterval(a,25)}
D(pg,M);pg.prototype.F=function(a){void 0===a.f&&jg(a);var b=a.f;void 0===a.g&&jg(a);this.f=new rc(b,a.g)};
pg.prototype.A=function(){if(this.f){var a=og();if(0!=this.j){var b=this.m,c=this.f,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.j);this.h[this.i]=.5<Math.abs((d-this.l)/this.l)?1:0;for(c=b=0;4>c;c++)b+=this.h[c]||0;3<=b&&this.w();this.l=d}this.j=a;this.m=this.f;this.i=(this.i+1)%4}};
pg.prototype.o=function(){window.clearInterval(this.K);ng(this.D)};var qg={};
function rg(a){var b=void 0===a?{}:a;a=void 0===b.Ea?!0:b.Ea;b=void 0===b.Qa?!1:b.Qa;if(null==z("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?C()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&sg();V(document,"keydown",sg);V(document,"keyup",sg);V(document,"mousedown",sg);V(document,"mouseup",sg);a&&(b?V(window,"touchmove",function(){tg("touchmove",200)},{passive:!0}):(V(window,"resize",function(){tg("resize",200)}),V(window,"scroll",function(){tg("scroll",200)})));
new pg(function(){tg("mouse",100)});
V(document,"touchstart",sg,{passive:!0});V(document,"touchend",sg,{passive:!0})}}
function tg(a,b){qg[a]||(qg[a]=!0,Pf(function(){sg();qg[a]=!1},b))}
function sg(){null==z("_lact",window)&&rg();var a=C();y("_lact",a,window);-1==z("_fact",window)&&y("_fact",a,window);(a=z("ytglobal.ytUtilActivityCallback_"))&&a()}
function ug(){var a=z("_lact",window);return null==a?-1:Math.max(C()-a,0)}
;var vg=Je("initial_gel_batch_timeout",1E3),wg=Math.pow(2,16)-1,xg=null,yg=0,zg={log_event:"events",log_interaction:"interactions"},Ag=Object.create(null);Ag.log_event="GENERIC_EVENT_LOGGING";Ag.log_interaction="INTERACTION_LOGGING";var Bg=new Set(["log_event"]),Cg={},Dg=0,Eg=0,Fg=0,Gg=!0,W=z("ytLoggingTransportLogPayloadsQueue_")||{};y("ytLoggingTransportLogPayloadsQueue_",W,void 0);var Hg=z("ytLoggingTransportTokensToCttTargetIds_")||{};y("ytLoggingTransportTokensToCttTargetIds_",Hg,void 0);
var Ig=z("ytLoggingTransportDispatchedStats_")||{};y("ytLoggingTransportDispatchedStats_",Ig,void 0);y("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);
function Jg(){T(Dg);T(Eg);Eg=0;if(!$a(W)){for(var a in W){var b=Cg[a];if(b&&b.isReady()){var c=void 0,d=a,e=b,f=zg[d],g=Ig[d]||{};Ig[d]=g;b=Math.round(U());for(c in W[d]){var h=db,k=e.f||Kg();k={client:{hl:k.Ia,gl:k.Ha,clientName:k.Ga,clientVersion:k.innertubeContextClientVersion,configInfo:k.Fa}};var l=window.devicePixelRatio;l&&1!=l&&(k.client.screenDensityFloat=String(l));l=Q("EXPERIMENTS_TOKEN","");""!==l&&(k.client.experimentsToken=l);var m=l=void 0,p=[],u=Q("EXPERIMENTS_FORCED_FLAGS",{});for(m in u)p.push({key:m,
value:String(u[m])});m=Q("EXPERIMENT_FLAGS",{});for(l in m)l.startsWith("force_")&&void 0===u[l]&&p.push({key:l,value:String(m[l])});l=p;0<l.length&&(k.request={internalExperimentFlags:l});Q("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(k.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});h=h({context:k});h[f]=Lg(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=h[f].length;if(k=Hg[c])a:{p=h;u=c;if(k.videoId)l="VIDEO";else if(k.playlistId)l="PLAYLIST";else break a;
p.credentialTransferTokenTargetId=k;p.context=p.context||{};p.context.user=p.context.user||{};p.context.user.credentialTransferTokens=[{token:u,scope:l}]}delete Hg[c];k=h;k.requestTimeMs=b;R("unsplit_gel_payloads_in_logs")&&(k.unsplitGelPayloadsInLogs=!0);if(l=Q("EVENT_ID",void 0))p=Q("BATCH_CLIENT_COUNTER",void 0)||0,!p&&R("web_client_counter_random_seed")&&(p=Math.floor(Math.random()*wg/2)),p++,p>wg&&(p=1),P("BATCH_CLIENT_COUNTER",p),l={serializedEventId:l,clientCounter:p},k.serializedClientEventId=
l,xg&&yg&&R("log_gel_rtt_web")&&(k.previousBatchInfo={serializedClientEventId:xg,roundtripMs:yg}),xg=l,yg=0;Mg(e,d,h,{retry:Bg.has(d),onSuccess:Ka(Ng,U())})}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?((c.averageTimeBetweenDispatchesMs||0)*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete W[a];Gg=!1}}$a(W)||Og()}}
function Og(){R("web_gel_timeout_cap")&&!Eg&&(Eg=S(Jg,6E4));T(Dg);var a=Q("LOGGING_BATCH_TIMEOUT",Je("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&Gg&&(a=vg);Dg=S(Jg,a)}
function Lg(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
function Ng(a){yg=Math.round(U()-a)}
;var Pg=z("ytLoggingGelSequenceIdObj_")||{};y("ytLoggingGelSequenceIdObj_",Pg,void 0);
function Qg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:ug())};R("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,Pg[b]=b in Pg?Pg[b]+1:0,a.sequence={index:Pg[b],groupKey:b},d.sb&&delete Pg[d.P]);(d=d.da)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),Hg[d.token]=a,d=Lg("log_event",d.token)):d=Lg("log_event");d.push(e);c&&(Cg.log_event=new c);c=Je("web_logging_max_batch")||
100;e=U();d.length>=c?Jg():10<=e-Fg&&(Og(),Fg=e)}
;function Rg(){return"INNERTUBE_API_KEY"in ne&&"INNERTUBE_API_VERSION"in ne}
...
function Sg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.pb||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().ob:b=Pc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function Ug(a,b,c,d){nc.set(""+a,b,{ma:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})}
;function Vg(){var a=new fe;(a=a.isAvailable()?new le(a,"yt.innertube"):null)||(a=new ge("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new be(a):null;this.g=document.domain||window.location.hostname}
Vg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,C()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(yd(b))}catch(f){return}else e=escape(b);Ug(a,e,c,this.g)};
Vg.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=nc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Vg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;nc.remove(""+a,"/",void 0===b?"youtube.com":b)};var Wg=new Vg;function Xg(a,b,c,d){if(d)return null;d=Wg.get("nextId",!0)||1;var e=Wg.get("requests",!0)||{};e[d]={method:a,request:b,authState:Tg(c),requestTime:Math.round(U())};Wg.set("nextId",d+1,86400,!0);Wg.set("requests",e,86400,!0);return d}
function Yg(a){var b=Wg.get("requests",!0)||{};delete b[a];Wg.set("requests",b,86400,!0)}
function Zg(a){var b=Wg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=Tg(Sg(!1));bb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),Mg(a,d.method,e,{}));delete b[c]}}Wg.set("requests",b,86400,!0)}}
;function $g(a){var b=this;this.f=null;a?this.f=a:R("delay_gel_until_config_ready")?Rg()&&(this.f=Kg()):this.f=Kg();Qf(function(){Zg(b)},0,5E3)}
$g.prototype.isReady=function(){!this.f&&Rg()&&(this.f=Kg());return!!this.f};
function Mg(a,b,c,d){!Q("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ve(Error("Missing VISITOR_DATA when sending innertube request."));var e={headers:{"Content-Type":"application/json"},method:"POST",C:c,ra:"JSON",O:function(){d.O()},
qa:d.O,onSuccess:function(u,t){if(d.onSuccess)d.onSuccess(t)},
oa:function(u){if(d.onSuccess)d.onSuccess(u)},
onError:function(u,t){if(d.onError)d.onError(t)},
wb:function(u){if(d.onError)d.onError(u)},
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ja;g&&(f=g);g=a.f.Ka||!1;var h=Sg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=Ce(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Xg(b,c,h,g))){var m=e.onSuccess,p=e.oa;e.onSuccess=function(u,t){Yg(l);m(u,t)};
c.oa=function(u,t){Yg(l);p(u,t)}}try{R("use_fetch_for_op_xhr")?Te(k,e):(e.method="POST",e.C||(e.C={}),We(k,e))}catch(u){if("InvalidAccessError"==u)l&&(Yg(l),l=0),ve(Error("An extension is blocking network request."));
else throw u;}l&&Qf(function(){Zg(a)},0,5E3)}
;var ah=C().toString();
function bh(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=C();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ah)for(a=1,b=0;b<ah.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ah.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var ch=z("ytLoggingTimeDocumentNonce_")||bh();y("ytLoggingTimeDocumentNonce_",ch,void 0);function dh(a){this.f=a}
function eh(a){var b={};void 0!==a.f.trackingParams?b.trackingParams=a.f.trackingParams:(b.veType=a.f.veType,null!=a.f.veCounter&&(b.veCounter=a.f.veCounter),null!=a.f.elementIndex&&(b.elementIndex=a.f.elementIndex));void 0!==a.f.dataElement&&(b.dataElement=eh(a.f.dataElement));void 0!==a.f.youtubeData&&(b.youtubeData=a.f.youtubeData);return b}
dh.prototype.toString=function(){return JSON.stringify(eh(this))};
var fh=1;function gh(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function hh(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function ih(a){return Q(hh(void 0===a?0:a),void 0)}
y("yt_logging_screen.getRootVeType",ih,void 0);function jh(){var a=ih(0),b;a?b=new dh({veType:a,youtubeData:void 0}):b=null;return b}
function kh(){var a=Q("csn-to-ctt-auth-info");a||(a={},P("csn-to-ctt-auth-info",a));return a}
function lh(a){a=void 0===a?0:a;var b=Q(gh(a));if(!b&&!Q("USE_CSN_FALLBACK",!0))return null;b||0!=a||(R("kevlar_client_side_screens")||R("c3_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
y("yt_logging_screen.getCurrentCsn",lh,void 0);function mh(a,b,c){var d=kh();(c=lh(c))&&delete d[c];b&&(d[a]=b)}
function nh(a){return kh()[a]}
y("yt_logging_screen.getCttAuthInfo",nh,void 0);function oh(a,b,c,d){c=void 0===c?0:c;if(a!==Q(gh(c))||b!==Q(hh(c)))mh(a,d,c),P(gh(c),a),P(hh(c),b),0==c&&(b=function(){setTimeout(function(){a&&Qg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:ch,clientScreenNonce:a},$g)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
y("yt_logging_screen.setCurrentScreen",oh,void 0);function ph(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=Na(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Mb(f,d),d=f.href),d){g=d.match(Qb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:lh()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Pb(d).toString(36),e=e?Sb(e):"",Ug(b,e,k||5))}else k=b,e="ST-"+Pb(d).toString(36),k=k?Sb(k):"",Ug(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=Tb(a,l)+m;a=a instanceof G?a:Cb(a);c.href=Ab(a)}return!0}
;function qh(a,b){this.version=a;this.args=b}
;function rh(a,b){this.topic=a;this.f=b}
rh.prototype.toString=function(){return this.topic};var sh=z("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.N;O.prototype.publish=O.prototype.M;O.prototype.clear=O.prototype.clear;y("ytPubsub2Pubsub2Instance",sh,void 0);var th=z("ytPubsub2Pubsub2SubscribedKeys")||{};y("ytPubsub2Pubsub2SubscribedKeys",th,void 0);var uh=z("ytPubsub2Pubsub2TopicToKeys")||{};y("ytPubsub2Pubsub2TopicToKeys",uh,void 0);var vh=z("ytPubsub2Pubsub2IsAsync")||{};y("ytPubsub2Pubsub2IsAsync",vh,void 0);
y("ytPubsub2Pubsub2SkipSubKey",null,void 0);function wh(a,b){var c=xh();c&&c.publish.call(c,a.toString(),a,b)}
function yh(a){var b=zh,c=xh();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=z("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(th[d])try{if(f&&b instanceof rh&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.H){var l=new h;h.H=l.version}var m=h.H}catch(p){}if(!m||k.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
Ta(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){ue(p)}},vh[b.toString()]?z("yt.scheduler.instance")?Pf(g):S(g,0):g())});
th[d]=!0;uh[b.toString()]||(uh[b.toString()]=[]);uh[b.toString()].push(d);return d}
function Ah(){var a=Bh,b=yh(function(c){a.apply(void 0,arguments);Ch(b)});
return b}
function Ch(a){var b=xh();b&&("number"===typeof a&&(a=[a]),F(a,function(c){b.unsubscribeByKey(c);delete th[c]}))}
function xh(){return z("ytPubsub2Pubsub2Instance")}
;function Dh(a){qh.call(this,1,arguments);this.csn=a}
r(Dh,qh);var zh=new rh("screen-created",Dh),Eh=[],Fh=0;function Gh(a,b,c){b={csn:a,parentVe:eh(b),childVes:Pa(c,function(e){return eh(e)})};
c=q(c);for(var d=c.next();!d.done;d=c.next())d=eh(d.value),($a(d)||!d.trackingParams&&!d.veType)&&of(Error("Child VE logged with no data"),"WARNING");c={da:nh(a),P:a};"UNDEFINED_CSN"==a?Hh("visualElementAttached",b,c):Qg("visualElementAttached",b,$g,c)}
function Hh(a,b,c){Eh.push({Pa:a,payload:b,options:c});Fh||(Fh=Ah())}
function Bh(a){if(Eh){for(var b=q(Eh),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Qg(c.Pa,c.payload,null,c.options));Eh.length=0}Fh=0}
;function Ih(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||cb(b);this.assets=a.assets||{};this.attrs=a.attrs||cb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Ih.prototype.clone=function(){var a=new Ih,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=cb(c):a[b]=c}return a};function Jh(){M.call(this);this.f=[]}
r(Jh,M);Jh.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.qb)}M.prototype.o.call(this)};var Kh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Lh(a){a=a||"";if(window.spf){var b=a.match(Kh);spf.style.load(a,b?b[1]:"",void 0)}else Mh(a)}
function Mh(a){var b=Nh(a),c=document.getElementById(b),d=c&&tf(c,"loaded");d||c&&!d||(c=Oh(a,b,function(){tf(c,"loaded")||(rf(c),Cf(b),S(Ka(Df,b),0))}))}
...
function Nh(a){var b=xc(document,"A");Mb(b,new G(yb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Pb(a)}
;function Ph(a,b,c,d){M.call(this);var e=this;this.m=this.X=a;this.U=b;this.w=!1;this.api={};this.V=this.D=null;this.F=new O;id(this,Ka(jd,this.F));this.j={};this.R=this.W=this.h=this.ca=this.f=null;this.K=!1;this.l=this.A=null;this.Y={};this.ua=["onReady"];this.ba=null;this.ka=NaN;this.S={};this.i=d;Qh(this);this.Z("WATCH_LATER_VIDEO_ADDED",this.Ma.bind(this));this.Z("WATCH_LATER_VIDEO_REMOVED",this.Na.bind(this));this.Z("onAdAnnounce",this.wa.bind(this));this.va=new Jh(this);id(this,Ka(jd,this.va));
this.T=0;c?this.T=S(function(){e.loadNewVideoConfig(c)},0):d&&(Rh(this),Sh(this))}
r(Ph,M);n=Ph.prototype;n.getId=function(){return this.U};
n.loadNewVideoConfig=function(a){if(!this.g){this.T&&(T(this.T),this.T=0);a instanceof Ih||(a=new Ih(a));this.ca=a;this.f=a.clone();Rh(this);this.W||(this.W=Th(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Ic(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Ic(Number(a)||a);Sh(this);this.w&&Uh(this)}};
function Rh(a){var b;a.i?b=a.i.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.U,a.f.attrs.id=a.U);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
n.Ba=function(){return this.ca};
function Uh(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Vh(a){var b=!0,c=Wh(a);c&&a.f&&(a=Xh(a),b=tf(c,"version")===a);return b&&!!z("yt.player.Application.create")}
function Sh(a){if(!a.g&&!a.K){var b=Vh(a);if(b&&"html5"==(Wh(a)?"html5":null))a.R="html5",a.w||Yh(a);else if(Zh(a),a.R="html5",b&&a.l)a.X.appendChild(a.l),Yh(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.A=function(){c=!0;if(a.i)var d=a.i.serializedExperimentFlags;else a.f&&a.f.args&&(d=a.f.args.fflags);d="true"==ze(d||"").player_bootstrap_method?z("yt.player.Application.createAlternate")||z("yt.player.Application.create"):z("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.X,e,a.i);Yh(a)};
a.K=!0;b?a.A():(Hf(Xh(a),a.A),Lh(a.i?a.i.cssUrl:a.f.assets.css),$h(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function Wh(a){var b=tc(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function Yh(a){if(!a.g){var b=Wh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||ai(a)):a.ka=S(function(){Yh(a)},50)}}
function ai(a){Qh(a);a.w=!0;var b=Wh(a);b.addEventListener&&(a.D=bi(a,b,"addEventListener"));b.removeEventListener&&(a.V=bi(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=bi(a,b,e))}for(var f in a.j)a.D(f,a.j[f]);Uh(a);a.W&&a.W(a.api);a.F.M("onReady",a.api)}
function bi(a,b,c){var d=b[c];return function(){try{return a.ba=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ba=e,ve(e))}}}
function Qh(a){a.w=!1;if(a.V)for(var b in a.j)a.V(b,a.j[b]);for(var c in a.S)T(parseInt(c,10));a.S={};a.D=null;a.V=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Z.bind(a);a.api.removeEventListener=a.Sa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ca.bind(a);a.api.getPlayerType=a.Da.bind(a);a.api.getCurrentVideoConfig=a.Ba.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.La.bind(a)}
n.La=function(){return this.w};
n.Z=function(a,b){var c=this,d=Th(this,b);if(d){if(!(0<=Na(this.ua,a)||this.j[a])){var e=ci(this,a);this.D&&this.D(a,e)}this.F.subscribe(a,d);"onReady"==a&&this.w&&S(function(){d(c.api)},0)}};
n.Sa=function(a,b){if(!this.g){var c=Th(this,b);c&&Wd(this.F,a,c)}};
function Th(a,b){var c=b;if("string"==typeof b){if(a.Y[b])return a.Y[b];c=function(){var d=z(b);d&&d.apply(x,arguments)};
a.Y[b]=c}return c?c:null}
function ci(a,b){var c="ytPlayer"+b+a.U;a.j[b]=c;x[c]=function(d){var e=S(function(){if(!a.g){a.F.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
ab(a.S,String(e))};
return c}
n.wa=function(a){Cf("a11y-announce",a)};
n.Ma=function(a){Cf("WATCH_LATER_VIDEO_ADDED",a)};
n.Na=function(a){Cf("WATCH_LATER_VIDEO_REMOVED",a)};
n.Da=function(){return this.R||(Wh(this)?"html5":null)};
n.Ca=function(){return this.ba};
function Zh(a){a.cancel();Qh(a);a.R=null;a.f&&(a.f.loaded=!1);var b=Wh(a);b&&(Vh(a)||!$h(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.X;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){this.A&&Nf(Xh(this),this.A);T(this.ka);this.K=!1};
n.o=function(){Zh(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){ue(b)}this.Y=null;for(var a in this.j)x[this.j[a]]=null;this.ca=this.f=this.api=null;delete this.X;delete this.m;M.prototype.o.call(this)};
function $h(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Xh(a){return a.i?a.i.jsUrl:a.f.assets.js}
;var di={},ei="player_uid_"+(1E9*Math.random()>>>0);function fi(a){delete di[a.getId()]}
;function gi(a,b){qh.call(this,1,arguments)}
r(gi,qh);function hi(a,b){qh.call(this,1,arguments)}
r(hi,qh);var ii=new rh("aft-recorded",gi),ji=new rh("timing-sent",hi);var ki=window;function li(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var X=ki.performance||ki.mozPerformance||ki.msPerformance||ki.webkitPerformance||new li;var mi=!1;function ni(){var a=oi(void 0);if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function pi(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},La("ytcsi."+(a||"")+"data_",b));return b}
function qi(a){a=pi(a);a.info||(a.info={});return a.info}
function oi(a){a=pi(a);a.tick||(a.tick={});return a.tick}
function ri(a){var b=pi(a).nonce;b||(b=bh(),pi(a).nonce=b);return b}
function si(){var a=oi(""),b=ni();b&&!mi&&(wh(ii,new gi(Math.round(b-a._start),void 0)),mi=!0)}
;function ti(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!ui(a)||c.some(function(e){return!ui(e)}))throw Error("Only objects may be merged.");
c=q(c);for(d=c.next();!d.done;d=c.next())vi(a,d.value);return a}
function vi(a,b){for(var c in b)if(ui(b[c])){if(c in a&&!ui(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});vi(a[c],b[c])}else if(wi(b[c])){if(c in a&&!wi(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);xi(a[c],b[c])}else a[c]=b[c];return a}
function xi(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,ui(d)?a.push(vi({},d)):wi(d)?a.push(xi([],d)):a.push(d);return a}
function ui(a){return"object"===typeof a&&!Array.isArray(a)}
function wi(a){return"object"===typeof a&&Array.isArray(a)}
;function yi(){var a=z("ytcsi.debug");a||(a=[],y("ytcsi.debug",a,void 0),y("ytcsi.reference",{},void 0));return a}
function zi(a){a=a||"";var b=z("ytcsi.reference");b||(yi(),b=z("ytcsi.reference"));if(b[a])return b[a];var c=yi(),d={timerName:a,info:{},tick:{}};c.push(d);return b[a]=d}
;function Ai(a,b,c){c=void 0===c?{}:c;var d=$g;Q("ytLoggingEventsDefaultDisabled",!1)&&$g==$g&&(d=null);Qg(a,b,d,c)}
;var Bi=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",Bi,void 0);function Ci(){this.f=0}
function Di(){Ci.instance||(Ci.instance=new Ci);return Ci.instance}
Ci.prototype.tick=function(a,b,c){Ei(this,"tick_"+a+"_"+b)||Ai("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
Ci.prototype.info=function(a,b){var c=Object.keys(a).join("");Ei(this,"info_"+c+"_"+b)||(a.clientActionNonce=b,Ai("latencyActionInfo",a))};
function Ei(a,b){Bi[b]=Bi[b]||{count:0};var c=Bi[b];c.count++;c.time=U();a.f||(a.f=Qf(function(){var d=U(),e;for(e in Bi)Bi[e]&&6E4<d-Bi[e].time&&delete Bi[e];a&&(a.f=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new hf("CSI data exceeded logging limit with key",b),0===b.indexOf("info")?mf(c):lf(c)),!0):!1}
...
"webInfo.nonPreloadedNodeCount",Y.prt="playbackRequiresTap",Y.plt="playerInfo.playbackType",Y.pis="playerInfo.playerInitializedState",Y.paused="playerInfo.isPausedOnLoad",Y.yt_pt="playerType",Y.fmt="playerInfo.itag",Y.yt_pl="watchInfo.isPlaylist",Y.yt_pre="playerInfo.preloadType",Y.yt_ad_pr="prerollAllowed",Y.pa="previousAction",Y.yt_red="isRedSubscriber",Y.rce="mwebInfo.responseContentEncoding",Y.scrh="screenHeight",Y.scrw="screenWidth",Y.st="serverTimeMs",Y.aq="tvInfo.appQuality",Y.br_trs="tvInfo.bedrockTriggerState",
Y.kebqat="kabukiInfo.earlyBrowseRequestInfo.abandonmentType",Y.kebqa="kabukiInfo.earlyBrowseRequestInfo.adopted",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.upg_player_vis="playerInfo.visibilityState",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y.rcl="mwebInfo.responseContentLength",Y.GetSettings_rid="mwebInfo.getSettingsRequestId",
Y.GetTrending_rid="mwebInfo.getTrendingRequestId",Y.GetMusicSearchSuggestions_rid="musicInfo.getMusicSearchSuggestionsRequestId",Y),Gi="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Hi={},Ii=(Hi.mver="MEASUREMENT_VERSION_",Hi.pis="PLAYER_INITIALIZED_STATE_",Hi.yt_pt=
"LATENCY_PLAYER_",Hi.pa="LATENCY_ACTION_",Hi.yt_vst="VIDEO_STREAM_TYPE_",Hi),Ji="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds GetLibrary_rid".split(" ");function Ki(a){return!!Q("FORCE_CSI_ON_GEL",!1)||R("csi_on_gel")||!!pi(a).useGel}
function Li(a){a=pi(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function Mi(a,b,c){if(null!==b)if(qi(c)[a]=b,Ki(c)){var d=Li(c);if(d.gelInfos)d.gelInfos["info_"+a]=!0;else{var e={};d.gelInfos=(e["info_"+a]=!0,e)}if(a in Fi){d=Fi[a];0<=Na(Gi,d)&&(b=!!b);a in Ii&&"string"===typeof b&&(b=Ii[a]+b.toUpperCase());a=d.split(".");e=d={};for(var f=0;f<a.length-1;f++){var g=a[f];e[g]={};e=e[g]}e[a[a.length-1]]=b;b=ti({},d)}else 0<=Na(Ji,a)||mf(new hf("Unknown label logged with GEL CSI",a)),b=void 0;b&&Ki(c)&&(a=zi(c||""),ti(a.info,b),a=Li(c),"gelInfos"in a||(a.gelInfos=
{}),ti(a.gelInfos,b),c=ri(c),Di().info(b,c))}else zi(c||"").info[a]=b}
if(R("overwrite_polyfill_on_logging_lib_loaded")){var Ni=window;Ni.ytcsi&&(Ni.ytcsi.info=Mi)};A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Oi(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Pi(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});a:{if((b=a.mediaContentUrl)&&(b=/\/([ve]|embed)\/([^#?]+)/.exec(b))&&b[2]){b=b[2];break a}b=null}a.videoId=b;return Qi(a)}
function Qi(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function Ri(a,b,c,d){if(Da(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Si(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);id(this,Ka(jd,this.f))}
D(Si,M);Si.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
r(Ti,Si);function Ui(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(yd(a),d.i))}}
Ti.prototype.o=function(){this.i=this.h=null;Si.prototype.o.call(this)};function Vi(a){M.call(this);this.f=a;this.f.subscribe("command",this.sa,this);this.h={};this.j=!1}
r(Vi,M);n=Vi.prototype;n.start=function(){this.j||this.g||(this.j=!0,Ui(this.f,"RECEIVING"))};
n.sa=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=A(this.Ua,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Wi(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=Xi(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Yi(a,c))&&this.j&&!this.g&&Ui(this.f,a,c))}}};
n.Ua=function(a,b){this.j&&!this.g&&Ui(this.f,a,this.fa(a,b))};
n.fa=function(a,b){if(null!=b)return{value:b}};
function Wi(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||Wd(a.f,"command",this.sa,this);this.f=null;for(var b in this.h)Wi(this,b);M.prototype.o.call(this)};function Zi(a,b){Vi.call(this,b);this.i=a;this.start()}
...
Zi.prototype.fa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Vi.prototype.fa.call(this,a,b)};
Zi.prototype.o=function(){Vi.prototype.o.call(this);delete this.i};function $i(a,b,c){M.call(this);var d=this;c=c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.A=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.A&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r($i,M);$i.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ve(e)}}};
$i.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function aj(){var a=this.g=new $i(!!Q("WIDGET_ID_ENFORCE")),b=A(this.Ra,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=aj.prototype;n.Ra=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,bj(this,a)),this.j[a]=!0)):this.na(a,b,c)};
n.na=function(){};
function bj(a,b){return A(function(c){this.sendMessage(b,c)},a)}
...
function cj(a,b){a.sendMessage("infoDelivery",b)}
n.ta=function(a){this.l?this.g.sendMessage(a):this.i.push(a)};
n.sendMessage=function(a,b){this.ta({event:a,info:void 0==b?null:b})};
n.dispose=function(){this.g=null};function dj(a){aj.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Oa,this));this.addEventListener("onVideoProgress",A(this.Ya,this));this.addEventListener("onVolumeChange",A(this.Za,this));this.addEventListener("onApiChange",A(this.Ta,this));this.addEventListener("onPlaybackQualityChange",A(this.Va,this));this.addEventListener("onPlaybackRateChange",A(this.Wa,this));this.addEventListener("onStateChange",A(this.Xa,this));this.addEventListener("onWebglSettingsChanged",A(this.ab,
this))}
r(dj,aj);n=dj.prototype;n.na=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Oi(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Qi.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Pi.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Ri.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Oi(a)&&cj(this,this.ga())}};
...
n.Xa=function(a){a={playerState:a,currentTime:this.f.getCurrentTime(),duration:this.f.getDuration(),videoData:this.f.getVideoData(),videoStartBytes:0,videoBytesTotal:this.f.getVideoBytesTotal(),videoLoadedFraction:this.f.getVideoLoadedFraction(),playbackQuality:this.f.getPlaybackQuality(),availableQualityLevels:this.f.getAvailableQualityLevels(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getVideoUrl&&(a.videoUrl=
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());cj(this,a)};
n.Va=function(a){cj(this,{playbackQuality:a})};
n.Wa=function(a){cj(this,{playbackRate:a})};
n.Ta=function(){for(var a=this.f.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.f.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var k=f[g],l=this.f.getOption(e,k);b[e][k]=l}}this.sendMessage("apiInfoDelivery",b)};
n.Za=function(){cj(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());cj(this,a)};
n.ab=function(){var a={sphericalProperties:this.f.getSphericalProperties()};cj(this,a)};
n.dispose=function(){aj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function ej(a,b,c){M.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new Ti(this,a,b);id(this,Ka(jd,this.h))}
r(ej,M);ej.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ej.prototype.o=function(){ng(this.j);this.f=null;M.prototype.o.call(this)};function fj(){var a=cb(gj),b;return Ld(new N(function(c,d){a.onSuccess=function(e){Me(e)?c(e):d(new hj("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new hj("Unknown request error","net.unknown",e))};
a.O=function(e){d(new hj("Request timed out","net.timeout",e))};
b=We("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Md&&b.abort();
return Jd(c)})}
function hj(a,b){E.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
r(hj,E);function ij(){this.g=0;this.f=null}
ij.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Ed(a)?a:jj(a)):2===this.g&&b?(a=b.call(c,this.f),Ed(a)?a:kj(a)):this};
ij.prototype.getValue=function(){return this.f};
ij.prototype.$goog_Thenable=!0;function kj(a){var b=new ij;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function jj(a){var b=new ij;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function lj(a){E.call(this,a.message||a.description||a.name);this.isMissing=a instanceof mj;this.isTimeout=a instanceof hj&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Md}
r(lj,E);lj.prototype.name="BiscottiError";function mj(){E.call(this,"Biscotti ID is missing from server")}
r(mj,E);mj.prototype.name="BiscottiMissingError";var gj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},nj=null;function xe(){if("1"===Xa(pe(),"args","privembed"))return Jd(Error("Biscotti ID is not available in private embed mode"));nj||(nj=Ld(fj().then(oj),function(a){return pj(2,a)}));
return nj}
function oj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new mj;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new mj;a=a.id;ye(a);nj=jj(a);qj(18E5,2);return a}
function pj(a,b){var c=new lj(b);ye("");nj=kj(c);0<a&&qj(12E4,a-1);throw c;}
function qj(a,b){S(function(){Ld(fj().then(oj,function(c){return pj(b,c)}),xa)},a)}
function rj(){try{var a=z("yt.ads.biscotti.getId_");return a?a():xe()}catch(b){return Jd(b)}}
;function sj(a){if("1"!==Xa(pe(),"args","privembed")){a&&we();try{rj().then(function(){},function(){}),S(sj,18E5)}catch(b){ue(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function tj(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=nc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
n=tj.prototype;n.get=function(a,b){uj(a);vj(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){uj(a);vj(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
n.remove=function(a){uj(a);vj(a);delete Z[a]};
n.save=function(){Ug(this.f,this.dump(),63072E3)};
...
function wj(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
ya(tj);var xj=null,yj=null,zj=null,Aj={};function Bj(a){var b=a.id;a=a.ve_type;var c=fh++;a=new dh({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Aj[b]=a;b=lh();c=jh();b&&c&&Gh(b,c,[a])}
function Cj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(oh(b,a),a=jh()))for(var c in Aj){var d=Aj[c];d&&Gh(b,a,[d])}}
function Dj(a){Aj[a.id]=new dh({trackingParams:a.tracking_params})}
function Ej(a){var b=lh();a=Aj[a.id];if(b&&a){a={csn:b,ve:eh(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var c={da:nh(b),P:b};"UNDEFINED_CSN"==b?Hh("visualElementGestured",a,c):Qg("visualElementGestured",a,$g,c)}}
function Fj(a){a=a.ids;var b=lh();if(b)for(var c=0;c<a.length;c++){var d=Aj[a[c]];if(d){var e=b;d={csn:e,ve:eh(d),eventType:1};var f={da:nh(e),P:e};"UNDEFINED_CSN"==e?Hh("visualElementShown",d,f):Qg("visualElementShown",d,$g,f)}}}
;y("yt.setConfig",P,void 0);y("yt.config.set",P,void 0);y("yt.setMsg",qf,void 0);y("yt.msgs.set",qf,void 0);y("yt.logging.errors.log",of,void 0);
y("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);sj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?tc(b):b;var e=ei+"_"+Ea(b),f=di[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new Ph(b,e,a,void 0),di[e]=f,Cf("player-added",f.api),id(f,Ka(fi,f)));a=f.api;xj=a;a.addEventListener("onScreenChanged",Cj);a.addEventListener("onLogClientVeCreated",Bj);a.addEventListener("onLogServerVeCreated",Dj);a.addEventListener("onLogVeClicked",Ej);a.addEventListener("onLogVesShown",Fj);d=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?zj=new dj(a):Q("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(yj=new ej(window.parent,d,c),zj=new Zi(a,yj.h));
c=Q("BG_P",void 0);dg(c)&&(Q("BG_I")||Q("BG_IU"))&&($f=!0,Zf.initialize(Q("BG_I",null),Q("BG_IU",null),c,cg,void 0));Uf()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){df(a+"mac_204?action_fcts=1");return!0},void 0);
var Gj=te(function(){var a=oi(void 0),b;(b=!R("use_first_tick"))||(b=!("ol"in oi(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=U(),a.ol=b,a=Li(void 0),a.gelTicks&&(a.gelTicks.tick_ol=!0),U(),Ki(void 0)?(zi("").tick.ol=U(),a=ri(void 0),Di().tick("ol",a,void 0),si(),a=!0):a=!1,!a)){if(!z("yt.timing.pingSent_")&&(b=Q("TIMING_ACTION",void 0),a=oi(void 0),z("ytglobal.timingready_")&&b&&a._start&&ni())){si();b=!0;var c=Q("TIMING_WAIT",[]);if(c.length)for(var d=
0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}if(b&&!Ki(void 0)){d=oi(void 0);c=qi(void 0);e=d._start;var f=Q("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:Q("TIMING_ACTION",void 0)};a=c.srt;void 0!==d.srt&&delete c.srt;if(c.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:void 0)?c.h5jse=Math.round(c.h5jse-g.responseEnd):delete c.h5jse}d.aft=ni();var h=oi(void 0);g=h.pbr;var k=h.vc;h=h.pbs;g&&k&&h&&g<k&&k<h&&qi(void 0).yt_pvis&&
"youtube"==f&&(Mi("yt_lt","hot_bg",void 0),f=d.vc,g=d.pbs,delete d.aft,c.aft=Math.round(g-f));for(var l in c)"_"!=l.charAt(0)&&(b[l]=c[l]);d.ps=U();l={};f=[];for(var m in d)"_"!=m.charAt(0)&&(g=Math.round(d[m]-e),l[m]=g,f.push(m+"."+g));b.rt=f.join(",");(m=z("ytdebug.logTiming"))&&m(b,l);m=!!c.ap;R("debug_csi_data")&&(c=z("yt.timing.csiData"),c||(c=[],La("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:b}));c="";for(var p in b)b.hasOwnProperty(p)&&(c+="&"+p+"="+b[p]);p="/csi_204?"+
c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&m){var u=void 0===u?"":u;gf(p,u)||df(p,void 0,void 0,void 0,u)}else df(p);y("yt.timing.pingSent_",!0,void 0);wh(ji,new hi(l.aft+(a||0),void 0))}}zi("").tick.ol=U()}u=tj.getInstance();m=!!((wj("f"+(Math.floor(119/31)+1))||0)&67108864);p=1<window.devicePixelRatio;document.body&&nd(document.body,"exp-invert-logo")&&(p&&!nd(document.body,"inverted-hdpi")?(l=document.body,l.classList?l.classList.add("inverted-hdpi"):nd(l,"inverted-hdpi")||
(a=ld(l),md(l,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!p&&nd(document.body,"inverted-hdpi")&&od());m!=p&&(m="f"+(Math.floor(119/31)+1),l=wj(m)||0,l=p?l|67108864:l&-67108865,0==l?delete Z[m]:(p=l.toString(16),Z[m]=p.toString()),u.save())}),Hj=te(function(){var a=xj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Zf.dispose();a=0;for(var b=Sf.length;a<b;a++){var c=Sf[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Sf.length=0;Mf("//static.doubleclick.net/instream/ad_status.js");Tf=!1;P("DCLKSTAT",0);kd(zj,yj);if(a=xj)a.removeEventListener("onScreenChanged",Cj),a.removeEventListener("onLogClientVeCreated",Bj),a.removeEventListener("onLogServerVeCreated",Dj),a.removeEventListener("onLogVeClicked",Ej),a.removeEventListener("onLogVesShown",
Fj),a.destroy();Aj={}});
window.addEventListener?(window.addEventListener("load",Gj),window.addEventListener("unload",Hj)):window.attachEvent&&(window.attachEvent("onload",Gj),window.attachEvent("onunload",Hj));La("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||eg);La("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||fg);La("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||Vf);
La("yt.player.exports.navigate",z("yt.player.exports.navigate")||ph);La("yt.util.activity.init",z("yt.util.activity.init")||rg);La("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||ug);La("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||sg);}).call(this);
